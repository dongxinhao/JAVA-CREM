...
<script type="text/javascript" src="<%=path%>/bizjs/foot/privCentre/privShareResource.js"></script>
...
<div data-options="region:'north',border:false" style="padding:10px">
    ...
    <input id="queryType" class="easyui-textbox" data-options="prompt:'分享目标'" style="width:20%;height:30px">
...
<div data-options="region:'center'">
    ...
    <div id="m1" class="easyui-menu" style="width:120px;">
        ...
        <div id="img_back" data-options="iconCls:'icon-back'">撤回</div>
    </div>

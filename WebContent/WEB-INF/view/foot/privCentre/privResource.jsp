...
<script type="text/javascript" src="<%=path%>/bizjs/foot/privCentre/privResource.js"></script>
...
<div data-options="region:'center'">
    ...
    <div id="m1" class="easyui-menu" style="width:120px;">
        ...
        <div id="img_share" data-options="iconCls:'icon-man'">分享</div>
    </div>
    <div id="addCPM" align="center">
        <form align="center" action="<%=path%>/privFoot/upFile" method="post" enctype="multipart/form-data">
    ...
    <div id="shareCPM">
        <table align="center" style="font: bold 12px/17px Arial;">
            ...
            <tr>
                <td style="width: 80px">分享到→：</td>
                <td>
                    <input id="shareCombobox" class="easyui-combobox" style="width:150px;">
        ...
        <div id="footer" style="padding:5px;" align="center">
            <a id="shareSubmit" style="border-radius: 25px;color: red;font: bold 12px/17px Arial"
               class="easyui-linkbutton">&nbsp;&nbsp;&nbsp;&nbsp;保存&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <div id="close" style="border-radius: 25px;font: bold 12px/17px Arial" class="easyui-linkbutton" >&nbsp;&nbsp;&nbsp;&nbsp;关闭&nbsp;&nbsp;&nbsp;&nbsp;</div>
        </div>
    </div>
</div>

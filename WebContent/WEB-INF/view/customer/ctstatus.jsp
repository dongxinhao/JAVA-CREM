...
<script type="text/javascript" src="<%=path%>/bizjs/customer/ctstatus.js"></script>
...
<div data-options="region:'north',border:false" style="padding:10px">
    ...
    <a id="status_query" onclick="query()" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width: 80px">搜   索</a>
    <a  id="status_add"  class="easyui-linkbutton" data-options="iconCls:'icon-add'" style="width: 80px">增   加</a>
...
<div data-options="region:'center',title:''">
    ...
    <div id="m1" class="easyui-menu" style="width:120px;">
        <div id="status_update"  data-options="iconCls:'icon-remove'">编辑</div>
        <div id="status_del"  data-options="iconCls:'icon-no'">删除</div>
    </div>
    <div id="addCPM">
        <table align="center" style="font: bold 12px/17px Arial;">
            ...
            <tr>
                <td>客户状态：</td>
                <td>
                    <input id="ctStatus" class="easyui-textbox"  iconWidth="28" style="width:150px;height:30px;padding:10px;">
            ...
            <tr>
                <td>备注：</td>
                <td>
                    <input id="statusMessage" class="easyui-textbox"  iconWidth="150"   data-options="multiline:true" style="width:150px;height:150px;">
                    <b class="emptyS" style="color: red;display: none;font-size: 18px">*</b>
                </td>
            </tr>
        </table>
        <div id="footer" style="padding:5px;" align="center">
            <a id="addStatus" style="border-radius: 25px;color: red;font: bold 12px/17px Arial" class="easyui-linkbutton">&nbsp;&nbsp;&nbsp;&nbsp;保存&nbsp;&nbsp;&nbsp;&nbsp;</a>
